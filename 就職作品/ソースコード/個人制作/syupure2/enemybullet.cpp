...
void UpdateEnemyBullet(void)
{
	...
	for(int nCntEnemyBullet = 0; nCntEnemyBullet < MAX_ENEMYBULLET; nCntEnemyBullet++)
	{
		if(g_aEnemyBullet[nCntEnemyBullet].bUse)
		{
			...
			/*SetVertexShadow(g_aEnemyBullet[nCntEnemyBullet].nIdxShadow, fSizeX, fSizeY);*/
		...
		/*	SetColorShadow(g_aEnemyBullet[nCntEnemyBullet].nIdxShadow, D3DXCOLOR(1.0f, 1.0f, 1.0f, colA));*/
		}
	}
}
