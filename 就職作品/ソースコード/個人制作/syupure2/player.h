...
// マクロ定義
//*****************************************************************************
#define PLAYER_SIZE_X       (40.0f)				//プレイヤーの大きさ
#define PLAYER_SIZE_Y       (40.0f)				//プレイヤーの大きさ
#define PLAYER_SIZE_Z       (40.0f)				//プレイヤーの大きさ
#define ACCEL_TIME			(360)				//加速時間
...
typedef struct
{
	...
	D3DXVECTOR2 oldpos;					//昔の座標
	D3DXVECTOR2 curmv;					//カーソルの移動量
	D3DXVECTOR2 setcur;					//カーソルのセット座標
