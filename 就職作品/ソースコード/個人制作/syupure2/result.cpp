...
// マクロ定義
//*****************************************************************************
#define	TEXTURE_RESULT		"data/TEXTURE/result.jpg"		// 読み込むテクスチャファイル名
#define	TEXTURE_RESULT_LOGO	"data/TEXTURE/result.jpg"	// 読み込むテクスチャファイル名

#define	RESULT_LOGO_POS_X	(240)		// リザルトロゴの位置(X座標)
#define	RESULT_LOGO_POS_Y	(320)		// リザルトロゴの位置(Y座標)
#define	RESULT_LOGO_WIDTH	(100000)		// リザルトロゴの幅
#define	RESULT_LOGO_HEIGHT	(100000)		// リザルトロゴの高さ
...
void UpdateResult(void)
{
	...
	if(GetKeyboardTrigger(DIK_RETURN) || IsButtonPressed(0, BUTTON_O))
