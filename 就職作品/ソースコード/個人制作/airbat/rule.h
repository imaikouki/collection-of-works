...
#define TEXTURE_RULE5		("data/TEXTURE/sayu.png")			// 読み込むテクスチャファイル名
#define TEXTURE_RULE6		("data/TEXTURE/l1.png")				// 読み込むテクスチャファイル名
#define TEXTURE_RULE7		("data/TEXTURE/clear.png")			// 読み込むテクスチャファイル名
#define TEXTURE_RULE8		("data/TEXTURE/zyunbi.png")			// 読み込むテクスチャファイル名
