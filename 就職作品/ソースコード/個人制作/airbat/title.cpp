...
// マクロ定義
//*****************************************************************************
#define	TEXTURE_TITLE		"data/TEXTURE/nc17088.jpg"		// 読み込むテクスチャファイル名
#define	TEXTURE_TITLE_LOGO	"data/TEXTURE/AIRBAT.png"	// 読み込むテクスチャファイル名
#define	TEXTURE_LOGO_START	"data/TEXTURE/press_enter.png"	// 読み込むテクスチャファイル名

#define	TITLE_LOGO_POS_X		(50)		// タイトルロゴの位置(X座標)
