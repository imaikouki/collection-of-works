...
#define BUTTON_RIGHT_UP		0x00400000l	// 右スティックの上(.rgbButtons[19]&0x80)
#define BUTTON_RIGHT_DOWN	0x00800000l	// 右スティック下(.rgbButtons[20]&0x80)
#define BUTTON_RIGHT_LEFT	0x01000000l	// 右スティック左(.rgbButtons[21]&0x80)
#define BUTTON_RIGHT_RIGHT	0x02000000l	// 右スティック右(.rgbButtons[22]&0x80)
